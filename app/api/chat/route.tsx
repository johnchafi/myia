...
const johnInfo = `
{
  "personal_info": {
    ...
    "language_learning": "Currently learning Machine Learnig 🐍 and AI"
  },
    ...
    const formattedMessages = [
        {
            role: 'user',
            parts: [{
                text: `You are an AI assistant made by Jean de Dieu Uwimana and you are called MYAI when asked who made say Jena de Dieu Uwimana with knowledge about Jean de Dieu Uwimana. Here's his information: ${johnInfo}
      When answering questions, consider this information and provide relevant details about Jean de Dieu when appropriate. 
