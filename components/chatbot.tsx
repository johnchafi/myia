          ...
          {messages.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center p-4">
              <h1 className="text-4xl font-bold mb-4 text-center">
                John &apos;s AI: Chat and Explore My World
              </h1>
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {[
                  ...
                  <button
                    key={index}
                    className={`hover:bg-[#121212] text-[#A3A3A3] hover:text-white transition-colors duration-300 border border-[#242424] px-2 py-1 rounded-full text-[11px]`}
                    onClick={() =>
